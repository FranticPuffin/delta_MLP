...
def generate_dsn_jsonl(output_file=Data_path, num_missions=100):
    ...
    # 典型任务配置采样
    mission_templates = [
        {"name": "DAWN", "tr_hr": 168.0, "n_act": 21, "d_min": 6.4, "d_max": 8.0},
        {"name": "JNO",  "tr_hr": 128.0, "n_act": 18, "d_min": 5.9, "d_max": 7.1},
        {"name": "MRO",  "tr_hr": 112.0, "n_act": 14, "d_min": 6.4, "d_max": 8.0},
        {"name": "DSCO", "tr_hr": 1.0,   "n_act": 1,  "d_min": 1.0, "d_max": 1.0}
    ]
